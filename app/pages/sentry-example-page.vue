...
<template>
  ...
  <div>
    <main>
      ...
      <p class="description">
        Click the button below, and view the sample error on the Sentry <a target="_blank" href="https://zenithcodes.sentry.io/issues/?project=4511547466711040">Issues Page</a>.
